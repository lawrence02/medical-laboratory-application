# MedicalLaboratoryAndClinicalScientistsCouncil
...
To build the final jar and optimize the MedicalLaboratoryAndClinicalScientistsCouncil application for production, run:
